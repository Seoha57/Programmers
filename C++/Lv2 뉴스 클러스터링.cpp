...
vector<string> bindTwo(string str) {
    vector<string> bind;
...
int solution(string str1, string str2) {
    vector<string> string1 = bindTwo(str1);
    vector<string> string2 = bindTwo(str2);
    
    vector<bool> intersected(string1.size(), false);
    float intersect = 0;
    
    for(int i = 0; i < string2.size(); ++i) {
        for(int j = 0; j < string1.size(); ++j) {
            if(string1[j] == string2[i] && !intersected[j]) {
                ++intersect;
                intersected[j] = true;
                break;
            }
    ...
    return int(intersect / (string1.size() + string2.size() - intersect) * 65536);
}